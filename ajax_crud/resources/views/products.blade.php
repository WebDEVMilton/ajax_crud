...
<body>
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-8">
                <h2 class="my-5 text-center">Laravel 10 AJax Crud (Web Journey)</h2>
                <a href="" class="btn btn-success my-3" data-bs-toggle="modal" data-bs-target="#addModal">Add
                    Product</a>
                <div class="deleteMsg">

                </div>
                <input type="text" name="search" id="search" class="form-control mb-2 mb-3" placeholder="Search Here.......">
